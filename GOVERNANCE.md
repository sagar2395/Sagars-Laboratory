...
Flightdeck is an open-source project with a **maintainer-led** governance model.
...
[CLA](CLA.md) and follow [CONTRIBUTING.md](CONTRIBUTING.md).
...
Flightdeck's core (engine, CLI, SDK, community content) is and will remain fully
