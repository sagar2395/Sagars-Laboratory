...
import (
	...
	"go.flightdeck.dev/flightdeck/pkg/checks"
	"go.flightdeck.dev/flightdeck/pkg/extension"
	schema "go.flightdeck.dev/flightdeck/pkg/scenario"
)
...
func (e *Engine) scan() {
	// In-repo scenarios. External content roots (FLIGHTDECK_CONTENT_PATH) scan
